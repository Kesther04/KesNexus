...
export default function Contact () {
    return (
        <section className="flex flex-col py-20 px-2 md:px-32 min-h-full space-y-10 bg-gray-300" id="contact">
            ...
            <div className="flex flex-col md:flex-row justify-between gap-20 py-6 w-full">
                ...
                <div className='flex flex-col justify-start space-y-10 w-1/3 text-lg'>
                    ...
                    <p className="text-gray-700 dark:text-gray-300 hover:text-blue-950">
                    ...
                    <div className="flex space-x-4 ">
                        <a href="https://x.com/kes_ther?s=09" target="_blank" rel="noopener noreferrer">
                            <Icon icon="fa6-brands:x-twitter" className='text-gray-600 transition ease-in-out duration-200 hover:text-blue-950' width="28" height="28"  />
                        </a>
                        <a href="https://www.linkedin.com/in/kesther-ogbu-5703b0317/" target="_blank" rel="noopener noreferrer">
                            <Icon icon="mdi:linkedin" className="text-gray-600 transition ease-in-out duration-200 hover:text-blue-950" width="28" height="28" />
                        </a>
                        <a href="https://www.instagram.com/kes__ther" target="_blank" rel="noopener noreferrer">
                            <Icon icon="mdi:instagram" className="text-gray-600 transition ease-in-out duration-200 hover:text-blue-950" width="28" height="28" />
                        </a>
                        <a href="https://github.com/kesther04" target="_blank" rel="noopener noreferrer">
                            <Icon icon="mdi:github" className="text-gray-600 transition ease-in-out duration-200 hover:text-blue-950" width="28" height="28" />
                        </a>
                    </div>
                </div>
            </div>
