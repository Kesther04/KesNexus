            ...
            <div className="flex flex-col md:flex-row justify-between gap-20 py-6 w-full">
                ...
                <div className='w-full md:w-2/3'>
                    <form className="space-y-4">
                        ...
                        <button type="submit" className="px-6 py-2 bg-primary text-white rounded-lg hover:bg-blue-800 transition">
                            Send Message
                        </button>
                    </form>
                </div>
                ...
                <div className='flex flex-col justify-start space-y-10 w-1/3 text-lg'>
                    ...
                    <div className="flex space-x-4 ">
                        <a href="https://x.com/kes_ther?s=09" target="_blank" rel="noopener noreferrer">
                            <Icon icon="fa6-brands:x-twitter" className='text-gray-600 transition ease-in-out duration-200 hover:text-primary' width="28" height="28"  />
                        </a>
                        <a href="https://www.linkedin.com/in/kesther-ogbu-5703b0317/" target="_blank" rel="noopener noreferrer">
                            <Icon icon="mdi:linkedin" className="text-gray-600 transition ease-in-out duration-200 hover:text-primary" width="28" height="28" />
                        </a>
                        <a href="https://www.instagram.com/kes__ther" target="_blank" rel="noopener noreferrer">
                            <Icon icon="mdi:instagram" className="text-gray-600 transition ease-in-out duration-200 hover:text-primary" width="28" height="28" />
                        </a>
                        <a href="https://github.com/kesther04" target="_blank" rel="noopener noreferrer">
                            <Icon icon="mdi:github" className="text-gray-600 transition ease-in-out duration-200 hover:text-primary" width="28" height="28" />
                        </a>
                    </div>
                </div>
            </div>
